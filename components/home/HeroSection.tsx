  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-warm-950">
      ...
      <motion.div
        ...
        className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-40 bg-gradient-to-b from-transparent via-gold to-transparent origin-top"
      />
          ...
          >
            ...
            <span className="relative inline-block">
              ...
              <motion.span
                initial={{ scaleX: 0 }}
                animate={{ scaleX: 1 }}
                transition={{ duration: 0.7, delay: 1.1, ease: [0.33, 1, 0.68, 1] }}
      ...
      >
        <span className="text-[10px] font-sans tracking-luxury uppercase">Scroll</span>
        <motion.div
          animate={{ y: [0, 6, 0] }}
